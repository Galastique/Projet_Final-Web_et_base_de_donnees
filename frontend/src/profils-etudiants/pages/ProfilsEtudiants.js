...
const ProfilsEtudiants = (props) => {
    return <div>
        ...
        <p>Nos étudiants en Gestion de réseaux et sécurité ont suivi des cours leur permettant de:</p><br/>
            <ul>
        ...
        <p>Nos étudiant en Développement d'applications informatiques ont suivi des cours leur permettant de:</p><br/>
            <ul>
